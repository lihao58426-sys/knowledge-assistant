...
GRAPH_DATA = {
    ...
    "rfm_report": {
        "nodes": [
            {"name":"server.py","category":0,"tech":"FastAPI · Basic Auth · 5个路由","file":"rfm_report/server.py"},
            {"name":"analysis.py","category":1,"tech":"RFM 8类分群 · 数据库驱动分析","file":"rfm_report/analysis.py"},
            {"name":"database.py","category":1,"tech":"SQLite · CSV导入清洗 · 批次管理","file":"rfm_report/database.py"},
            ...
            {"name":"home.html","category":1,"tech":"数据管理首页 · 批次列表 · 上传","file":"rfm_report/templates/home.html"},
            {"name":"report.html","category":1,"tech":"RFM报告 · ECharts · 分类跳转","file":"rfm_report/templates/report.html"},
            {"name":"query.html","category":1,"tech":"会员查询 · 动态RFM · 筛选导出","file":"rfm_report/templates/query.html"},
        ...
        "links": [
            ...
            {"source":"server.py","target":"home.html"},
            {"source":"server.py","target":"report.html"},
            {"source":"server.py","target":"query.html"},
            {"source":"analysis.py","target":"database.py"},
            ...
            {"source":"home.html","target":"query.html"},
            {"source":"query.html","target":"report.html"},
